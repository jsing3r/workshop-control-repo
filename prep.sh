...
curl "https://raw.githubusercontent.com/jsing3r/workshop-control-repo/production/workshop_key.enc" -L -o ~/workshop_key.enc
...
git remote add origin git@github.com:jsing3r/workshop-control-repo
